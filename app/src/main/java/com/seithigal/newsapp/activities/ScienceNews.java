...
public class ScienceNews extends AppCompatActivity {
    ...
    private String url = "https://saurav.tech/NewsAPI/top-headlines/category/science/in.json";
    ...
    private void fetchData() {
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Adapter adapter = new Adapter(ScienceNews.this, newsList);
                recyclerView.setLayoutManager(new LinearLayoutManager(ScienceNews.this));
