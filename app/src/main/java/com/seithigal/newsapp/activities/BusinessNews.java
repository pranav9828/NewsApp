...
public class BusinessNews extends AppCompatActivity {
    ...
    private String url = "http://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=c782068751084920bf337c1ddac137dd";
    ...
    private void fetchData() {
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Adapter adapter = new Adapter(BusinessNews.this, newsList);
