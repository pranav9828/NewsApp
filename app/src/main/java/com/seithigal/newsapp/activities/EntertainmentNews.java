...
public class EntertainmentNews extends AppCompatActivity {
    ...
    private String url = "https://saurav.tech/NewsAPI/top-headlines/category/entertainment/in.json";
    ...
    private void fetchData() {
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Adapter adapter = new Adapter(EntertainmentNews.this, newsList);
                recyclerView.setLayoutManager(new LinearLayoutManager(EntertainmentNews.this));
