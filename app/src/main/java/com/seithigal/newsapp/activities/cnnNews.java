...
public class cnnNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cnn_news);
    ...
    private void fetchData() {
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Adapter adapter = new Adapter(cnnNews.this, newsList);
                recyclerView.setLayoutManager(new LinearLayoutManager(cnnNews.this));
