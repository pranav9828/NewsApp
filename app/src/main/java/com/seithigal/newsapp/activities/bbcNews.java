...
public class bbcNews extends AppCompatActivity {
    ...
    private String url = "https://saurav.tech/NewsAPI/everything/bbc-news.json";
    ...
    private void fetchData() {
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Adapter adapter = new Adapter(bbcNews.this, newsList);
                recyclerView.setLayoutManager(new LinearLayoutManager(bbcNews.this));
