...
public class SportsNews extends AppCompatActivity {
    ...
    private String url = "https://saurav.tech/NewsAPI/top-headlines/category/sports/in.json";
    ...
    private void fetchData() {
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Adapter adapter = new Adapter(SportsNews.this, newsList);
                recyclerView.setLayoutManager(new LinearLayoutManager(SportsNews.this));
