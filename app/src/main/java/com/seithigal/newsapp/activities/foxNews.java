...
public class foxNews extends AppCompatActivity {
    ...
    private String url = "https://saurav.tech/NewsAPI/everything/fox-news.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Fox News");
    ...
    private void fetchData() {
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Adapter adapter = new Adapter(foxNews.this, newsList);
                recyclerView.setLayoutManager(new LinearLayoutManager(foxNews.this));
